...
| --- | --- | --- |
| [trustfill](applications/trustfill) | TypeScript | Answers a customer's security questionnaire from your own documents — and leaves blank what the evidence doesn't support |
